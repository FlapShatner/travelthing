                        ...
                        <div className="grid gap-6">
                            <div className="space-y-4">
                                ...
                                <div className="relative aspect-[3/1] overflow-hidden rounded-lg border border-gray-200 bg-gray-100">
                                    {headerImage ? (
                                        <img src={headerImage || "/placeholder.svg"} alt="Header" className="object-cover w-full h-full" />
                                    ) : (
                            ...
                            <div className="flex items-center space-x-4">
                                <div className="relative">
                                    <Avatar className="w-24 h-24">
                                        ...
                                        <AvatarFallback>
                                            {profilePicture ? null : <Camera className="w-8 h-8 text-gray-400" />}
                                        </AvatarFallback>
                                    </Avatar>
                                    <Input
                                        type="file"
                            ...
                            <div className="grid gap-4">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input id="twitter" placeholder="Enter your Twitter username" />
                                </div>
                                <div className="grid gap-2">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input id="github" placeholder="Enter your GitHub username" />
                                </div>
                            </div>
                        </div>
                    </form>
